...
async function deleteAllTieBreakers() {
  console.log('Deleting all tie breakers...');
  await db.tieBreaker.deleteMany({});
  console.log('Deleted all tie breakers');
}
